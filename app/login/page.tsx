      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            <div className="w-14 h-14 bg-blue-500/20 border border-blue-400/30 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <span className="text-2xl">🔑</span>
            </div>
            <h1 className="text-2xl font-bold text-white mb-1">ログイン</h1>
            <p className="text-slate-400 text-sm">ログインすると分析が無制限で使えます</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-400 mb-1.5">パスワード</label>
              <input
            ...
            <button
              ...
              className="w-full bg-blue-500 hover:bg-blue-400 disabled:opacity-60 text-white font-bold py-3 rounded-xl transition-colors">
              {loading ? "ログイン中..." : "ログイン"}
            </button>
          </form>
          ...
          <p className="text-center text-sm text-slate-400 mt-6">
            アカウントをお持ちでない方は{" "}
            <Link href="/signup" className="text-blue-400 hover:text-blue-300 font-semibold">新規登録</Link>
          </p>
        </div>
      </main>
    </div>
